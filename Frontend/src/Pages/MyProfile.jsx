  ...
  const updateUserProfileData = async () => {
    try {
      ...
      if (data.success) {
        ...
        loadUserProfile(); // No need to await
        setIsEdit(false);
      ...
      <div>
        ...
        <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
          ...
          onChange={(e) => {
            ...
            console.log("New DOB:", newDob); // Debugging
            setUserData(prev => ({ ...prev, dob: newDob }));
          }} 
          value={userData.dob || ""} 
        />
          ) : (
        ...
        <div className='mt-10'>
          {isEdit ? (
            <button className='border border-gray-400 px-8 py-2 rounded-full hover:bg-blue-600 hover:text-white transition-all cursor-pointer'
