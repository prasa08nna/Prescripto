...
const Header = () => {
  return (
    ...
    <div className="w-full md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 md:py-[10vw] md:mb-10 text-center md:text-left">
    ...
    <div className="w-full md:w-1/2 relative flex justify-center">
      <img className="w-full max-w-lg md:absolute bottom-0 h-auto rounded-lg" src={assets.header_img} alt="" />
    </div>
  </div>
